...
<p align="center">
  <img src="./assets/branding/taled-app-icon.svg" width="96" alt="Taled app icon" />
</p>
...
* [`cargo-quad-apk`](https://crates.io/crates/cargo-quad-apk)（用于 Android 构建）
...
| Crate | 作用 |
|-------|------|
| [`ply-engine`](https://crates.io/crates/ply-engine) | GPU 加速 UI 引擎，面向 Android 和桌面端 |
...
```text
apps/taled-editor/   Ply 引擎应用，面向 Android 和桌面端
